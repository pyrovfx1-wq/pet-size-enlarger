...
-------------------------------------------------------------------
-- 📌 Script 2: TOCHIPYRO Pet Enlarger GUI
-------------------------------------------------------------------
local ScreenGui = Instance.new("ScreenGui")
ScreenGui.Name = "TOCHIPYRO_GUI"
ScreenGui.ResetOnSpawn = false
ScreenGui.Parent = playerGui
ScreenGui.Enabled = false -- hide until Delta warning is confirmed

local Frame = Instance.new("Frame")
Frame.Name = "TOCHIPYRO"
...
TitleLabel.Text = "TOCHIPYRO - Pet Enlarger"
...
PetNameLabel.Position = UDim2.new(0.1, 0, 0.15, 0)
PetNameLabel.Size = UDim2.new(0, 80, 0, 30)
PetNameLabel.Font = Enum.Font.SourceSansBold
...
PetNameBox.Position = UDim2.new(0.4, 0, 0.15, 0)
PetNameBox.Size = UDim2.new(0, 150, 0, 30)
...
EnlargeButton.BackgroundColor3 = Color3.fromRGB(70, 130, 180)
EnlargeButton.Position = UDim2.new(0.3, 0, 0.5, 0)
EnlargeButton.Size = UDim2.new(0, 150, 0, 40)
EnlargeButton.Font = Enum.Font.SourceSansBold
EnlargeButton.Text = "Enlarge Pet"
EnlargeButton.TextColor3 = Color3.fromRGB(255, 255, 255)
...
CreditsLabel.Text = "Made by TOCHIPYRO"
...
-------------------------------------------------------------------
-- 📌 Logic: Only show TOCHIPYRO GUI after Delta Warning confirmed
-------------------------------------------------------------------
okayBtn.MouseButton1Click:Connect(function()
	screenGui1:Destroy() -- remove Delta Warning
	ScreenGui.Enabled = true -- enable Pet Enlarger UI
end)
